<?php
$baseRequirements = [ 'php' => [ 'required' => '7.2.0', 'recommended' => '7.4.0' ], 'mysql' => [ 'required' => '5.5.3', 'recommended' => '5.6.2' ] ]; // Base requirements for 4.6
...
<?php $success = TRUE; $installOnly = TRUE; ?>
			<section>
				...
				<ul>
<?php if ( version_compare( PHP_VERSION, $requirements['php']['required'] ) >= 0 ): ?>
					<li class="success">PHP version <?php echo PHP_VERSION; ?>.</li>
<?php else: $success = FALSE; ?>
					<li class="fail">You are not running a compatible version of PHP. You need PHP <?php echo $requirements['php']['required']; ?> or above (<?php echo $requirements['php']['recommended']; ?> or above recommended). You should contact your hosting provider or system administrator to ask for an upgrade.</li>
<?php endif; ?>
...
<?php endif; ?>
<?php else: ?>
				<p class="fail">You are not ready to upgrade to Invision Community <?php echo $majorVersion; ?> yet. See the information above for instructions how to fix or <a href="https://invisioncommunity.com/clientarea" target="_blank">contact technical support</a> for further assistance. If you're unable to fix the issues with your server, you may want to consider using <a href='https://invisioncommunity.com/buy'>Invision Cloud Community</a></p>
